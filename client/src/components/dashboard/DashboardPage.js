...
const DashboardPage = () => {
  ...
  return (
    <main
      className={`${styles.maintContent} ${styles.sectionPadding} ${styles.pagePadding}`}
    >
      <div className={styles.narrowContainerLayout}>
        <h2>Dashboard</h2>
        {loading && <Loader />}
        ...
        {categoryReports.length > 0 && (
          <CategoriesReport
            ...
            className={`${styles.halfWidth} ${styles.sectionPadding}`}
          />
        )}
